...
export function PoiCompactCard({ place, onPress }: PoiCompactCardProps) {
  ...
  return (
    <Pressable
      ...
      accessibilityLabel={t('a11yMustSeePlace', { name: place.name })}
    >
...
export const poiCompactCardWidth = CARD_WIDTH;
