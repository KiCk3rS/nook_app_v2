...
export type GuidanceResumeChoice = 'resume' | 'restart';

export function trackGuidanceStarted(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _resume: boolean,
  _citySlug?: string,
): void {
...
export function trackGuidanceStepViewed(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _stepIndex: number,
  _poiId: string,
): void {
  // guidance_step_viewed
}

export function trackGuidanceStepCompleted(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _stepIndex: number,
  _poiId: string,
...
export function trackGuidanceAudioTapped(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _poiId: string,
  _audioGuideId: string,
): void {
  // guidance_audio_tapped
}

export function trackGuidanceMapTapped(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _stepIndex: number,
): void {
...
export function trackGuidancePlaceDetailTapped(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _poiId: string,
): void {
  // guidance_place_detail_tapped
}

export function trackGuidanceQuitTapped(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _stepIndex: number,
  _confirmed: boolean,
): void {
  // guidance_quit_tapped
}

export function trackGuidanceCompleted(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _stepCount: number,
): void {
...
export function trackGuidanceResumePromptShown(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _savedStepIndex: number,
): void {
  // guidance_resume_prompt_shown
}

export function trackGuidanceResumeChoice(
  _sourceType: GuidanceSourceType,
  _itineraryId: string,
  _choice: GuidanceResumeChoice,
): void {
